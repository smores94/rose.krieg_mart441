...
function choose(option) {
    ...
    // Second-level choices after choosing 'book'
    ...
    // Second-level choices after choosing 'device'
    ...
    // Final outcomes for 'device' path
    else if (storyDiv.innerHTML.includes("Join the secret society")) {
        if (option === '1') {
            content = `
                <p>You join the secret society and uncover ancient alchemical secrets. The world is forever changed by your discoveries.</p>
                <img src="./imgs/cult.jpg" alt="The Society">
                <button onclick="restart()">Restart</button>
            `;
        } else if (option === '2') {
            content = `
                <p>You oppose the secret society, exposing their dark secrets to the world. Justice is served, but at a great cost.</p>
